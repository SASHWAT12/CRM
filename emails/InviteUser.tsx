...
export const InviteUserEmail = ({
  ...
  const previewText =
    userLanguage === "en"
      ? `You have been invited by ${invitedByUsername} to ${process.env.NEXT_PUBLIC_APP_NAME || "NextCRM"} app`
      : `Byl jste pozván uživatelem ${invitedByUsername} do aplikace ${process.env.NEXT_PUBLIC_APP_NAME || "NextCRM"}`;
