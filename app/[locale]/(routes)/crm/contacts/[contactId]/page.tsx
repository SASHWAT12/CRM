...
import { getContactTasks } from "@/actions/crm/contacts/get-tasks";

import AccountsView from "../../components/AccountsView";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { HistoryTab } from "./components/HistoryTab";
import { PatientTimelineSection } from "./components/PatientTimelineSection";
import PatientTasksView from "./components/PatientTasksView";
...
const ContactViewPage = async (props: any) => {
  ...
  const appointments = await getAppointments({ patientId: contactId });
    ...
    >
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="appointments">
          <PatientAppointmentsView data={appointments} contactId={contactId} />
        </TabsContent>
        <TabsContent value="followups">
          <PatientTasksView contactId={contactId} data={tasks} />
        </TabsContent>
